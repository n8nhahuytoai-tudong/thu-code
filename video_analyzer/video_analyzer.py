...
class VideoAnalyzer:
    ...
    def __init__(
        ...
        self.frame_extractor = FrameExtractor(output_dir="./output/frames")
        self.report_generator = ReportGenerator(output_dir="./output/reports")
...
Ví dụ:
  ...
  python video_analyzer.py --url https://youtube.com/watch?v=xxx --detail-level brief
        """
    )

    input_group = parser.add_mutually_exclusive_group(required=True)
    input_group.add_argument('--input', '-i', type=str, help='Đường dẫn file video local')
    input_group.add_argument('--url', '-u', type=str, help='URL video (YouTube, Vimeo, etc.)')
